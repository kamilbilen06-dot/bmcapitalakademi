...
<head>
  ...
  <link rel="stylesheet" href="assets/admin.css?v=20260902b">
</head>
<body>
  <div class="admin-shell">
    <aside class="sidebar" id="sidebar">
      ...
      <nav class="side-nav">
        ...
        <a href="#" class="nav-item" data-view="istatistik"><span class="ic">📈</span> Ziyaretçi Analizi</a>
  ...
  <script src="assets/admin.js?v=20260902b"></script>
</body>
</html>
