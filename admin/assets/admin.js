...
(function () {
  ...
  function drawAbonelikler() {
    ...
    el.wrap.innerHTML =
      ...
      '<div class="panel-body"><p class="hint">Grup ekleme/çıkarma siteden yapılmaz. WhatsApp’tan elle ekleyip buradan işaretleyin. Kişi <b>e-posta</b> ile ayırt edilir; her e-postaya en fazla bir abonelik vardır. Kart çekimi iyzico aboneliğidir. Dönem saati çekim saati değildir: üyelik o gün Türkiye saatiyle 24:00’e kadar açık kalır.</p></div>' +
      '<div class="table-wrap"><table><thead><tr>' +
