...
(function () {
  ...
  function drawAbonelikler() {
    ...
    el.wrap.innerHTML =
      ...
      '<div class="panel-body"><p class="hint">Grup ekleme/çıkarma siteden yapılmaz. WhatsApp’tan elle ekleyip buradan işaretleyin. Kart çekimi iyzico aboneliğidir. Aynı e-postaya ikinci abonelik açılmaz; iyzico’da kalan fazla kayıt kapatılır. Dönem saati çekim saati değildir: üyelik o gün Türkiye saatiyle 24:00’e kadar açık kalır. Gece iyzico’ya bakılır; çekildiyse aynı abone kalır, çekilmediyse süresi dolar.</p></div>' +
      '<div class="table-wrap"><table><thead><tr>' +
