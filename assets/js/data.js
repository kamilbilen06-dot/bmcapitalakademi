  ...
  egitimler: [
    {
      ...
      kisaAciklama:
        "Profesyonel teknik analiz, temel analiz ve algoritmik trade sistemlerini kapsayan uygulamalı hisse analizi eğitimi. Türkiye'nin tüm illerinden canlı online, İzmir'de yüz yüze.",
      gorsel: "assets/img/egitim-analiz.svg",
      fiyat: "20.000 TL",
      fiyatNot: "(KDV dahil)",
      sure: "20 saat",
      egitimTuru: "Canlı Online veya İzmir Yüz Yüze Eğitim",
      egitmenler: "Dr. Kamil BİLEN",
      katilimNot: "Canlı online veya İzmir yüz yüze · Grup dersi veya birebir özel ders olarak alınabilir.",
      tarihNot: "",
      tarihler: [],
      hediye: [],
      hediyeGorsel: "",
      ozellikler: [
        "Temel analiz ile bilanço okuma ve şirket değerini doğru hesaplama",
        "Profesyonel teknik analiz ile BIST 100 hisselerinde doğru zamanlama",
        "Uygulamalı hisse analizi ve veriye dayalı hisse seçimi",
        "AKD ve takas analizi ile kurumsal yatırımcı hareketlerini yorumlama",
        "Algoritmik düşünce yapısı kazanma ve stratejiyi kurallaştırma",
        "Kendi yatırım stratejinizi oluşturma ve geriye dönük test etme becerisi",
      ],
      aciklama: [
        "Finansal piyasalarda başarılı olmak tesadüf değildir.",
        "Bilimsel yöntem, veri analizi ve disiplinli sistem gerektirir.",
        "Bu program, Borsa İstanbul'da hisse senedi analizi yapmak isteyen yatırımcılar için hazırlanmış ileri seviye bir borsa eğitimidir. Temel analizden başlayıp profesyonel teknik analiz ve algoritmik strateji kurma aşamalarına ilerler.",
        ...
        "Eğitim canlı online verildiği için Türkiye'nin 81 ilinden katılabilirsiniz; İzmir'de yüz yüze, İstanbul ve Ankara'da grup talebine göre düzenlenir.",
      ],
      mufredat: [
        {
...

    {
      ...
      kisaAciklama:
        "BIST takas analizi ve aracı kurum analizi ile kurumsal yatırımcı hareketlerini okuyun. Kurum alım satım analizi, para giriş çıkış analizi ve BIST kurum dağılımı uygulamalı işlenir.",
      ...
      hediyeGorsel: "",
      ozellikler: [
        "Aracı kurum dağılımı (AKD) verisini okuma ve net pozisyon hesaplama",
        "BIST takas analizi ile kurum alım satım analizi yapma",
        "Kurumsal yatırımcı analizi: yerli ve yabancı kurum davranışını ayırt etme",
        "Para giriş çıkış analizi ve ortalama maliyet yorumu",
        "BIST kurum dağılımı verisini fiyat hareketiyle birlikte okuma",
        "AKD ve takas analizini birlikte kullanarak birikim ve dağıtım tespiti",
      ],
      aciklama: [
        "Piyasada büyük hacimli kurumsal oyuncuların hareketlerini takip etmek, doğru zamanlama için kritik bir avantajdır.",
        "Bu eğitimde BIST takas verisini ve aracı kurum dağılımını okuyarak paranın nereye aktığını yorumlamayı öğrenirsiniz. Aracı kurum analizi, kurum alım satım analizi ve para giriş çıkış analizi canlı BIST verisi üzerinde uygulamalı işlenir.",
